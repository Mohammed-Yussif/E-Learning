            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-success overflow-hidden">
                    <div class="card-header">
                        ...
                        <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> 9</h5>
                    </div>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-secondary overflow-hidden">
                    <div class="card-header pb-3">
                        ...
                        <h5 class="text-white mb-0"><i class="fa fa-caret-up"></i> 5</h5>
                    </div>
                                ...
                                <li>
                                    ...
                                    <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                        ...
                                        <div class="col">
                                            ...
                                            <small class="d-block">25 July 2024 - 02:26 PM</small>
                                        </div>
                                    </a>
                                </li>
                                <li>
