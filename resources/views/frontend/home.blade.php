                ...
                <div class="featured-popular-courses-heading d-flex align-content-center justify-content-between">
                    ...
                    <div class="nav-button featured-popular-courses-tabs">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-design-tab" data-bs-toggle=""
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-dev-tab" data-bs-toggle=""
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-bus-tab" data-bs-toggle=""
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link me-0" id="pills-its-tab" data-bs-toggle=""
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    <h5>
                                        Full-Stack Web Development Bootcamp: Basics to Advanced
                                    </h5>
            ...
            <div class="col-lg-6 order-2 order-lg-0">
                <div class="learning-rules-starts">
                    <h2 class="font-title--md">
                        With us Simple <br class="d-none d-md-block" />
                        Learning Steps
                    </h2>
    ...
    <div class="container about-services-area">
        ...
        <div class="testimonial testimonial--one testimonial__slider--one">
            <div class="testimonial__item">
                <p>
                    A successful experience in science and knowledge
                </p>
    ...
    <div class="container overflow-hidden">
        <div class="row mb-40">
            <div class="col-lg-6 mx-auto text-center brands-area-two-heading">
                ...
                <p>
                    Education is the basis of life and knowledge 
                </p>
            </div>
        </div>
        <div class="row">
